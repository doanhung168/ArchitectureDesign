...
public class TrackingForegroundAppService extends Service {
    ...
    public void getForegroundApp() {
        ...
        List<UsageStats> appList =
                usm.queryUsageStats(UsageStatsManager.INTERVAL_DAILY, time - 1000 * 60, time);
        ...
        if (!tempPackageName.equals(currentPackageName)) {
            ...
            String appName = Util.getAppNameByPackageName(getApplicationContext(), currentPackageName);
            mHandler.post(() -> {
